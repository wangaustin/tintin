...
export function mrb(now) {
    let cafe = "Suzie's (MRB III)"
    let timezone = CONST.TIMEZONE
    let whatDay = now.weekday
    // breakfast & lunch
...
// CENTRAL OPEN?
export function central(now) {
    let cafe = "Suzie's (Central/Food for Thought)"
    let timezone = CONST.TIMEZONE
    let whatDay = now.weekday
    // breakfast & lunch
    let wday_start1 = CONST.central_wday_normal_start
    let wday_end1 = CONST.central_wday_normal__end
    let wday_start2 = CONST.central_wday_friday_start
    let wday_end2 = CONST.central_wday_friday_end
